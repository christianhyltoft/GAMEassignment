...
public final class Settings {
    ...
    public static GUI_Field[] fields = new GUI_Field[]{
            ...
            new GUI_Street("Bernstorffsvej", "Cost:  3600", "Bernstorffsvej", "Rent:  300", new Color(153, 153, 153), Color.BLACK),
            new GUI_Chance("?", "Chance", "Take a chance card.", new Color(204, 204, 204), Color.BLACK),
            new GUI_Street("Hellerupvej", "Cost:  3600", "Hellerupvej", "Rent:  300", new Color(153, 153, 153), Color.BLACK),
            new GUI_Street("Strandvejen", "Cost:  4000", "Strandvejen", "Rent:  350", new Color(153, 153, 153), Color.BLACK),
            new GUI_Refuge("default", "Parking", "Parking", "Take a break", Color.WHITE, Color.BLACK),
            new GUI_Street("Trianglen", "Cost:  4400", "Trianglen", "Rent:  350", Color.RED, Color.BLACK),
            new GUI_Chance("?", "Chance", "Take a chance card.", new Color(204, 204, 204), Color.BLACK),
            new GUI_Street("Østerbro-\ngade", "Cost:  4400", "Østerbrogade", "Rent:  350", Color.RED, Color.BLACK),
            new GUI_Street("Grønningen", "Cost:  4800", "Grønningen", "Rent:  400", Color.RED, Color.BLACK),
            new GUI_Shipping("default", "Scandlines Gedser", "Cost:  4000", "Scandlines Gedser", "Rent:  500", Color.WHITE, Color.BLACK),
            new GUI_Street("Bredgade", "Cost:  5200", "Bredgade", "Rent:  450", Color.WHITE, Color.BLACK),
            new GUI_Street("Kgs. Nytorv", "Cost:  5200", "Kongens Nytorv", "rent:  450", Color.WHITE, Color.BLACK),
            new GUI_Brewery("default", "Carlsberg", "Cost:  3000", "Carlsberg brewery", "10 x [Dice-roll]", Color.BLACK, Color.WHITE),
            new GUI_Street("Østergade", "Cost:  5600", "Østergade", "Rent:  500", Color.WHITE, Color.BLACK),
